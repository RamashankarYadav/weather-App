...
const getWeatherData = async () => {
  const weatherUrl = `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&APPID=b5b648484c4e193aeb845d2ce0e8ce43`;
  try {
    ...
    // Assuming these are DOM elements you've selected earlier
...
// Ensure the event listener is added to the correct element
